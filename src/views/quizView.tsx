...
export default function QuizView(props: any){
    ...
    return(
            <div className="quizDiv">
                ...
                <button className={props.answer1? "answer1" : "hideButton"} onClick = {props.onClickAnswer}>{props.answer1}</button>
                <button className={props.answer2? "answer2" : "hideButton"} onClick = {props.onClickAnswer}>{props.answer2}</button>
